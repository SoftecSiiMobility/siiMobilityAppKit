...
var QueryManager = {
    ...
    createCategoriesQuery: function (categories, queryCoordinates, requestFrom) {
        ...
        return "?selection=" + queryCoordinates.join(";") + "&requestFrom=" + requestFrom + "&categories=" + categories.join(";") + "&maxResults=" + QueryManager.maxResults + "&maxDists=" + QueryManager.maxDists + "&format=" + QueryManager.format + "&lang=" + QueryManager.language + "&geometry=true";
    },

    createServiceQuery: function (serviceUri, requestFrom) {
        return "?serviceUri=" + serviceUri + "&requestFrom=" + requestFrom + "&format=" + QueryManager.format + "&lang=" + QueryManager.language;
    },
